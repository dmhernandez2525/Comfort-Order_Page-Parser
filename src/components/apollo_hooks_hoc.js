...
export function modalHOC(Component) {
  return function WrappedComponent(props) {
    ...
    return (
      <Component
        {...props}
        modalBool={modalQueryRead.modalBool}
        setModalCache={setModalCache}
      />
    );
  };
}
...
export function cartItemsGetter(Component) {
  return function WrappedComponent(props) {
    ...
    return (
      <Component
        {...props}
        cartItems={client.cache.data.data.ROOT_QUERY.cartItems["json"]}
      />
    );
  };
}
...
export function cartItemsSetter(Component) {
  return function WrappedComponent(props) {
    ...
    return (
      <Component {...props} cartItems={cartItems} addCartItems={addCartItems} />
    );
  };
}
